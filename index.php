        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Data Siswa</h6>
              <a class="btn btn-primary btn-sm" href="tambahSiswa.php">Tambah Siswa</a>
            </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <p class="text-sm font-weight-bold mb-0"><?= $siswa['nama'] ?></p>
                        </td>
                        ...
                        <td class="text-sm">
                          <a href="<?= $base_url ?>/detailnilai.php?id=<?= $siswa["id"] ?>" class="btn btn-success btn-xs">Detail</a>
                          <a href="/hapussiswa.php?id=<?= $siswa["id"] ?>" class="btn btn-danger btn-xs">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
